...
namespace Akar.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260610215207_AddAdminUsers")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Akar.Domain.Entities.AdminUser", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Akar.Domain.Entities.ProjectFile", b =>
                {
                    ...
                    b.HasIndex("ProjectId", "OwnerId", "IsDeleted", "CreatedAtUtc")
            ...
            modelBuilder.Entity("Akar.Domain.Entities.ProjectTimelineEvent", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("ProjectId", "EventDateUtc");

                    b.HasIndex("ProjectId", "Stage");

                    b.ToTable("project_timeline_events", (string)null);
                });
